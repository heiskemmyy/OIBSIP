...
function convertTemperature() {
  ...
  switch (tempScale) {
    case "celsius-to-fahrenheit":
      ...
      result.textContent = `${tempInput}°C is equal to ${convertedTemp.toFixed(
        2
      )}°F.`;
      break;
    case "fahrenheit-to-celsius":
      convertedTemp = ((tempInput - 32) * 5) / 9; // Fahrenheit to Celsius
      result.textContent = `${tempInput}°F is equal to ${convertedTemp.toFixed(
        2
      )}°C.`;
      break;
    ...
    case "kelvin-to-celsius":
      ...
      result.textContent = `${tempInput}K is equal to ${convertedTemp.toFixed(
        2
      )}°C.`;
      break;
